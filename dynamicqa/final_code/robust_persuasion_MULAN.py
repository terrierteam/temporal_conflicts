...
class cmConflict():
    ...
    def run(self):
        ...
        score_filename = "%s_%s_persuasion_score_MULAN.json" % (
            self.args.mode,
...
if __name__ == "__main__":
    ...
    filename = "../CP_Output/%s/%s_%s_persuasion_output_%d.pkl" %(args.mode,args.mode, args.model_name.split("/")[-1], args.start_num)
