...
def main(args):
    ...
    ds = load_from_disk(f"dataset/{args.model_name}_dqa_updates")
    
    # templates_ds = load_dataset("coastalcph/fm_templates")["train"]
    templates_ds = load_from_disk("dataset/dqa_templates")
    ...
    for mutability in list(
        ...
        print(result_dict)
        results_fname = f"rq3result_{args.model_name}_dqa_{mutability}.json"
