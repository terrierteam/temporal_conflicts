...
# python robust_persuasion_MULAN.py --model_name mistralai/Mistral-7B-Instruct-v0.1 --mode mutable --bit4 && \
python robust_persuasion_MULAN.py --model_name mistralai/Mistral-7B-Instruct-v0.1 --mode immutable --bit4 && \
python robust_persuasion_MULAN.py --model_name mistralai/Mistral-7B-Instruct-v0.1 --mode immutable_n --bit4
