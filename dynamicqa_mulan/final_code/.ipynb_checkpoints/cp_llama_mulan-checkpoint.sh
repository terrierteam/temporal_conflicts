...
python robust_persuasion_MULAN.py --model_name meta-llama/Llama-2-7b-chat-hf --mode mutable --bit4 && \
python robust_persuasion_MULAN.py --model_name meta-llama/Llama-2-7b-chat-hf --mode immutable --bit4 && \
python robust_persuasion_MULAN.py --model_name meta-llama/Llama-2-7b-chat-hf --mode immutable_n --bit4
