...
python robust_persuasion_gemma.py --model_name google/gemma-3-1b-it --mode dispute
python robust_persuasion_gemma.py --model_name google/gemma-3-1b-it --mode temporal
python robust_persuasion_gemma.py --model_name google/gemma-3-1b-it --mode static
python robust_persuasion_gemma.py --model_name google/gemma-3-4b-it --mode dispute
python robust_persuasion_gemma.py --model_name google/gemma-3-4b-it --mode temporal
python robust_persuasion_gemma.py --model_name google/gemma-3-4b-it --mode static
